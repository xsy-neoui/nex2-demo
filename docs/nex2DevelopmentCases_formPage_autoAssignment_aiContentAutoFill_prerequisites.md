...
2.  系统中必须上传并启用“AI 优化结果”页面的页面代码。
    ...
    ![](./images/nex2DevelopmentCases_formPage_autoAssignment_aiContentAutoFill_prerequisites1.png)

    ![](./images/nex2DevelopmentCases_formPage_autoAssignment_aiContentAutoFill_prerequisites2.png)

    ![](./images/nex2DevelopmentCases_formPage_autoAssignment_aiContentAutoFill_prerequisites3.png)
