...
5.  将自动生成的代码全部替换为以下代码：
    ...
    代码中 /rest/data/v2.0/xobjects/systemPolicyConfig\_\_c/3964022196062316 中的“3964022196062316”是配置数据的 ID，需根据实际情况进行替换。在“系统策略配置”对象列表页中双击数据的主属性字段，然后在打开页面的地址栏中查看该数据的 ID。（如果系统策略配置对象中没有数据，请参考[验证与测试](validation-testing.md)中的第一步先创建数据）

    ![](../../../../images/detailPage_dynamicControl_preventDirectContractAndOrderCreation_extensionDevelopment_web2.png)
...
6.  单击**保存**，然后单击**启用**。
    ...
    ![](../../../../images/detailPage_dynamicControl_preventDirectContractAndOrderCreation_extensionDevelopment_web1.png)
